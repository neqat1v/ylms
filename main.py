...
left_key = Message(WIDTH // 2 + 10, HEIGHT // 2 - 90, 20, "Press 'A' key to go left", instructions_font,
                   (255, 255, 255), win)
right_key = Message(WIDTH // 2 + 10, HEIGHT // 2 - 65, 20, "Press 'D' key to go right", instructions_font,
                    (255, 255, 255), win)
up_key = Message(WIDTH // 2 + 10, HEIGHT // 2 - 45, 20, "Press 'W' key to jump", instructions_font,
                 (255, 255, 255), win)
